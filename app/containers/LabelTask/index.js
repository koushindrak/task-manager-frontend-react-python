...
export class ManageTasks extends React.Component {
  ...
  getAllTasksListener(nextProps) {
    ...
    if(commonUtils.compare(nextProps.getAllTasksSuccess,this.props.getAllTasksSuccess)){
      ...
      if(this.props.match.params.id){
        ...
        const label_id = Number(this.props.match.params.id);
        const filteredTasks = tasks.filter(task => task.labels.some(label => label.id === label_id));
  ...
  addOrEditSubmitHandler = event => {
    ...
    if(this.props.match.params.id){
      payload.label_id=parseInt(this.props.match.params.id);
    }
          ...
          <div className="contentHeader">
            <div className="row">
              <div className="col-8">
                ...
                <p><span>Manage Labels For Tasks</span></p>
              </div>
              <div className="col-4">
