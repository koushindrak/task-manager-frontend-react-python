...
```bash
   ...
   /home/travis/build/gihrig/react-boilerplate/node_modules/react-router-scroll/lib'
    ...
    @ ./~/react-router-scroll/lib/material-ui-data-grid-table.js
    @ ./app/app.js
    @ multi ./app/app.js
```
...
- Warning: Observed on `npm start`
  ...
  @ ./app/components/Header/material-ui-data-grid-table.js 47:0-34
  @ ./app/containers/App/material-ui-data-grid-table.js
  @ ./app/app.js
